"use client";
import StatusIcon, { GetSuccessFailedIcon } from "@/components/ui/StatusIcon";
import { IconSize, StatusType } from "@/types";
...
const StatusIconExample: React.FC = () => {
  ...
  const statusDescriptions = {
    success:
      "Indicates successful operations, completed tasks, or positive states",
              ...
              {allStatuses.map((status) => (
                ...
                >
                  <StatusIcon
                    ...
                    onClick={() =>
                      setClickedIcon(
                        `${status} icon clicked at ${new Date().toLocaleTimeString()}`
                      )
                    }
        ...
        return (
          <div>
            ...
            <div style={{ marginTop: "40px" }}>
              ...
              <ul>
                <li>
                  <strong>Loading:</strong> Shows spinning animation while data
                  is being fetched
                </li>
                <li>
                  <strong>Pending:</strong> Indicates items waiting in queue
                  with subtle rotation
                </li>
                <li>
                  <strong>Other Icons:</strong> Can have hover effects or pulse
            ...
            {Object.entries(useCase).map(([status, cases]) => (
              ...
              >
                ...
                >
                  {
                    statusDescriptions[
                      status as keyof typeof statusDescriptions
                    ]
                  }
                </div>
                <div>
      ...
      case "backward-compatibility":
        return (
          <div>
            ...
            >
              <strong>Note:</strong> The GetSuccessFailedIcon function is
              deprecated. Use the new StatusIcon component for better
  ...
  return (
    <div className="ihub-py-5">
      ...
      <p>
        Enhanced status icon component with multiple status types, sizes, and
        customization options. Replaces the original GetSuccessFailedIcon with
      ...
      >
        ...
        <button
          className={`${
            currentExample === "backward-compatibility"
              ? "ihub-important-btn"
              : "ihub-outlined-btn"
          }`}
      ...
      <div className="ihub-mt-5">
        ...
        <ul>
          <li>
            <strong>success:</strong> CheckCircleIcon - For successful
            operations
          </li>
          <li>
            <strong>error:</strong> ErrorIcon - For errors and failures
          </li>
          <li>
            <strong>warning:</strong> WarningIcon - For warnings and cautions
          </li>
          <li>
            <strong>info:</strong> InfoIcon - For informational content
          </li>
          <li>
            <strong>pending:</strong> PendingIcon - For items waiting in queue
          </li>
          <li>
            <strong>loading:</strong> CircularProgress - For active processing
          </li>
          <li>
            <strong>question:</strong> HelpIcon - For help and documentation
          </li>
          <li>
            <strong>check:</strong> CheckIcon - For simple confirmations
          </li>
          <li>
            <strong>close:</strong> CloseIcon - For close/cancel actions
          </li>
        </ul>
        ...
        <ul>
          <li>
            <strong>Size Control:</strong> small, medium, large, inherit
          </li>
          <li>
            <strong>Custom Colors:</strong> Override default colors
          </li>
          <li>
            <strong>Custom Styling:</strong> Add borders, backgrounds, shadows
          </li>
          <li>
            <strong>CSS Classes:</strong> Apply custom CSS classes
          </li>
          <li>
            <strong>Animations:</strong> Enable spinning or pulse effects
          </li>
        </ul>
        ...
        <ul>
          <li>
            <strong>Click Handlers:</strong> Add onClick functionality
          </li>
          <li>
            <strong>Keyboard Navigation:</strong> Accessible with Tab and Enter
          </li>
          <li>
            <strong>Tooltips:</strong> Custom title text on hover
          </li>
          <li>
            <strong>ARIA Labels:</strong> Screen reader friendly
          </li>
          <li>
            <strong>Focus Management:</strong> Proper focus indicators
          </li>
        </ul>
        ...
        <ul>
          <li>
            <strong>GetSuccessFailedIcon:</strong> Original function still works
          </li>
          <li>
            <strong>Gradual Migration:</strong> Can upgrade components
            incrementally
          </li>
          <li>
            <strong>Same Styling:</strong> Maintains existing visual appearance
          </li>
          <li>
            <strong>No Breaking Changes:</strong> Existing code continues to
            work
          </li>
        </ul>
      </div>
