// app/page.jsx
"use client";
import PageNavigation from "../components/navbars/PageNavigation";
      ...
      <main className="ihub-container">
        ...
        <section className="ihub-hero mt-5 mb-5">
          <div className="ihub-hero-content pt-6 pb-6">
            <h1 className="tw-700">../../../../</h1>
            <p className="max_700">
              A modern React UI component library designed for building
              beautiful, responsive web applications with the InstinctHub design
              system.
            </p>
              ...
              <div className="accordion max_700">
                <div className="rc-accordion-card">
                  ...
                  <div className="rc-accordion-body">
                    <p>
                      InstinctHub UI is a React component library designed to
                      help developers build beautiful and accessible web
